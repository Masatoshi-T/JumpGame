...
public class GameScreen extends ScreenAdapter {
    ...
    int mHighScore;
    Preferences mPrefs;
    Music themesound = Gdx.audio.newMusic(Gdx.files.internal("theme.mp3"));
    Sound ef_sound = Gdx.audio.newSound(Gdx.files.internal("bang.mp3"));
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.masatoshi.tashiro.jumpactiongame"); // ←追加する
    ...
    private void createStage() {
        ...
        Texture enemyTexture = new Texture("icon_1r_128.png");

        // StepとStarをゴールの高さまで配置していく
        float y = 0;
        float enemy_Y = CAMERA_HEIGHT;
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            Enemy enemy = new Enemy(enemyTexture, 10, 10, 116, 116);
            enemy.setPosition(x, enemy_Y);
            mEnemy.add(enemy);
        ...
        // Playerを配置
        mPlayer = new Player(playerTexture, 8, 8, 72, 72);
